...
For a single cube pair each of the four magnets of one cube interacts with each magnet of the other cube, resulting in $16$ cube pair to consider for a physically accurate simulation.

...
\begin{xltabular}{\textwidth}{ l  X }
	...
	$\vec{a}$
	&
	Pivot walking axis of a polyomino in a global coordinate frame.
	...
	&
	Configurations of the configuration-space $\textit{SE}(2)$. $g_\textit{init}$ indicates the initial and $g_\textit{goal}$ the goal configuration of a local or a global plan.
	\\ \midrule

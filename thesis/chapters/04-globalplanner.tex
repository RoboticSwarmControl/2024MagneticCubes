...
% worst case is still bad. state example each note 50 options


%\subsection{Discretize Configurations}
%TODO dont know if I wil actually implement, but talk about benefits or why not that neccessary

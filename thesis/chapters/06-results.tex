...
% option sorting makes difference not only for shape but for initial if comparing seeds
% clusters can form -> we delevop k plans.
% k=1 102 md gs, 101 gl
% k=2 106 gs well seen in planning time and cost
% k=4 102 gl well seen in cost, time spreads
% k can get arbitrarely bad 100
% 100 had a timeout failure

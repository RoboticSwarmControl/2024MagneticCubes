...
Two plans can be concatenated when the goal of the first plan matches with the initial configuration of the second.
...
This saves computation time, although we might not return the best plan, since the fastest computation does not automatically mean the lowest costs.

...
A configuration when the polyominoes are stuck, or the maximum movement capacity is reached, are not good for further planning, but invalid polyominoes or polyominoes with gaps will definitely be omitted on a global scale.
...
%TODO comic sequence of the algorithm

...
Our global planner uses the ability of two-cutting polyominoes to create a two-cut-sub-assembly graph that is used as a building instruction for target polyominoes.
